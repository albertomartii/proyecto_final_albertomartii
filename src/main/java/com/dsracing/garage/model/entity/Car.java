...
public class Car implements Comparable<Car> {
    ...
    // "year" es palabra reservada en H2, se mapea como "car_year"
    @Column(name = "car_year")
    private int year;

    // Valores base para simulación
    private double basePower;             // HP
    ...
    public double getBaseTorque() { return baseTorque; }
    public void setBaseTorque(double baseTorque) { this.baseTorque = baseTorque; }

    public double getMass() { return mass; }
    public void setMass(double mass) { this.mass = mass; }

    public double getGripBase() { return gripBase; }
    public void setGripBase(double gripBase) { this.gripBase = gripBase; }

    public double getWeightDistributionFront() { return weightDistributionFront; }
